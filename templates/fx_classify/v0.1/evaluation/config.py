...
config = {
    ...
    "backtest": {
        "dir": ('/workspace/projects/change_me/training/iterations/04_03_2025_14_49_49'),
        ...
        "save_pred_dir": ('/workspace/projects/change_me/evaluation/predictions'),
    ...
    "explain": {
        ...
        "id_cols": ["date", "pair"],
        "prediction_dir": ('/workspace/projects/change_me/evaluation/predictions/04_03_2025_14_49_49_epoch10.db')
        },
    "metrics": {
        "db": ('/workspace/projects/change_me/evaluation/predictions/04_03_2025_14_49_49_epoch10.db'),
        "query": """
    ...
    "candidates": {
        ...
        "custom_func": True,
        "custom_func_path": ('/workspace/projects/change_me/evaluation/test_custom_eval_funcs.py'),
