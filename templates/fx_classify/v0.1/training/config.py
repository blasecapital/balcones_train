...
config = {
    ...
    "project_directory": ('/workspace/projects/'),
    ...
    "data_processing_modules_path": ('/workspace/projects/change_me/training/process_raw_data.py'),
    ...
    "bad_keys_path": ('/workspace/projects/change_me/training/change_me/bad_keys'),
    
    # Dictionary for cleaning and saving
    # Keys: meta, use for align arg
    #   Items: .env database path reference, query
    "align": {
        "hourly_features": ("FEATURE_DATABASE",
            """
            SELECT * FROM test_hourly_feature_data
    ...
    "scaler_save_dir": ('/workspace/projects/change_me/training/scalers'),
    ...
    "weight_dict_save_path": ('/workspace/projects/change_me/training/weights_dict/target_weights_dict.json'), 
    ...
    "model_modules_path": ('/workspace/projects/change_me/training/test_custom_train_funcs.py'),
    ...
    "weight_dict_path": ('/workspace/projects/change_me/training/weights_dict/target_weights_dict.json'), 
    "data_dir": ('/workspace/projects/change_me/training/prepped_data'),    
    "custom_loss": {"custom_loss_path": ('/workspace/projects/change_me/training/test_custom_train_funcs.py'),
    ...
    "epochs": 100,
    "batch_size": 64,
    "iteration_dir": ('/workspace/projects/change_me/training/iterations'),
    # Specify the file paths of the iteration config.py and model architecture file
    "requirements_paths": {
        "config": ('/workspace/projects/change_me/trainingconfig.py'),
        "model": ('/workspace/projects/change_me/training/test_custom_train_funcs.py')
        }
    }