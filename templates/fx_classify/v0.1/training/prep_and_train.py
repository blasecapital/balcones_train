...
def training(clean=False, prep=False, train=False):
    """
    ...
    if clean:
        ...
        if inspect:        
            clean.inspect_data(
                data_keys=['change_me'], # refers to the config's source_query keys
...
if __name__ == "__main__":
    training(clean=False, prep=False, train=False)