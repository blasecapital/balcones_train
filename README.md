...
- Copy the contents of `/templates/<use case category>/<version>` to `/projects`.
...
7. Walk through the /projects folder to become acquainted with the demo workflows
...
- [ ] **Expand project demos:** Demonstrate and verify versatility and make project setup easier.
