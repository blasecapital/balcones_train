...
config = {
    ...
    "project_directory": ('/workspace/tests/integration_tests/fx_classify/pipeline_0'),
    ...
    "data_processing_modules_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_process_raw_data.py'),
    ...
    "scaler_save_dir": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/scalers'),
    ...
    "prepped_data_dir": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/prepped_data'),
    ...
    "weight_dict_save_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/weights_dict/target_weights_dict.json'), 
    ...
    "model_modules_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_train_fn.py'),
    ...
    "weight_dict_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/weights_dict/target_weights_dict.json'), 
    "data_dir": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/prepped_data'),    
    "custom_loss": {"custom_loss_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_train_fn.py'),
    ...
    "epochs": 5,
    "batch_size": 64,
    "iteration_dir": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/iterations'),
    # Specify the file paths of the iteration config.py and model architecture file
    "requirements_paths": {
        "config": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/training_config.py'),
        "model": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_train_fn.py')
        }
    }