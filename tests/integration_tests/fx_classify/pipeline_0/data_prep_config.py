...
config = {
    ...
    "feature_batch": 4,
    "feature_modules_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_feature_fn.py'),
    ...
    "target_batch": 4,
    "target_modules_path": ('/workspace/tests/integration_tests/fx_classify/pipeline_0/pipeline_0_target_fn.py'),
